#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Provides an interface to binary grid search algorithm:

See https://github.com/mattalhonte/binary-grid-search/blob/master/binarygridsearch/binarygridsearch.py
"""
