...
def param_types():
    ...
    return DataFrame(
        {
            "alpha": {
                "Context": "lasso, ridge, elasticnet",
                "DataType": "float",
                "Default": 1.0,
                "Range Min": 1e-3,
                "Range Max": 5.0,
            ...
            "n_estimators": {
                "Context": "adaboost, gbt, forest, bagging",
                "DataType": "int",
                "Default": 50,
                "Range Min": 10.0,
                "Range Max": 300.0,
            ...
            "max_depth": {
                "Context": "decisiontree, gbt, forest",
                "DataType": "int",
                "Default": 3,
                "Range Min": 2.0,
                "Range Max": 5.0,
            ...
            "min_samples_leaf": {
                "Context": "decisiontree, forest, gbt",
                "DataType": "int",
                "Default": 1,
                "Range Min": 1,
                "Range Max": 5,
            ...
            "max_features": {
                "Context": "decisiontree, forest, gbt, bagging",
                "DataType": "category",
                "Default": "auto",
                "Range Min": nan,
                "Range Max": nan,
