...
def learning_curve(
    cv_results, perm=None, plot_size=3, score="RMSE", inverse_score=True
):
    ...
    if perm is not None:
        histogram(
            perm, bins=None, kde=None, ax=axes[3], x_label=score, title="Permutations"
        )
